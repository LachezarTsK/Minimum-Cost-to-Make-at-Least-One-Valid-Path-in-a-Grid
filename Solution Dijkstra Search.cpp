...
class Solution {
    ...
    inline static const auto comparator = [](const Point& x, const Point& y) {return x.costFromStart > y.costFromStart;};
            ...
            for (const auto& move : MOVES) {
                ...
                if (pointIsInGrid(nextRow, nextColumn)) {
                    ...
                    if (costFromStartToNextPoint < minCostPath[nextRow][nextColumn]) {
                        ...
                        minHeap.push(Point(nextRow, nextColumn, costFromStartToNextPoint));
                    }
                }
            }
        }
